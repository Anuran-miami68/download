...
final_dist_dir = os.path.join(current_dir, "dist", "Studio0808_Downloader_V20260603")

cmd_args = [
    'Studio0808_Downloader_V20260603.py',
    '--name=Studio0808_Downloader_V20260603',
    '--windowed',
    '--noconfirm',
    '--clean',
...
# Non-destructive copy/sync to dist/Studio0808_Downloader_V20260603
src_build_output = os.path.join(temp_dist_dir, "Studio0808_Downloader_V20260603")
